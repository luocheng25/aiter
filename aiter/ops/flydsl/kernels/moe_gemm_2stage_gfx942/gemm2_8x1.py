...
def _emit_k128n_body(
    ...
    def prologue():
        ...
        prefetch0_n, prefetch0_kb, prefetch0_half, _prefetch0_lds_slot = b_startup_coords(0)
        prefetch1_n, prefetch1_kb, prefetch1_half, _prefetch1_lds_slot = b_startup_coords(1)
